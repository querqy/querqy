...
/**
 * An Action represents all Instructions triggered for specific input positions. It references the sequence of query terms 
 * that matched the rule. As there can be more than one term in a single position it's possible that more than one
