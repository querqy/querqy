    ...
    public void testGetThatFieldProbabilityRatioIsReflectedInBoost() throws Exception {
        ...
        Analyzer queryAnalyzer = new Analyzer() {
            ...
            protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
                WhitespaceTokenizer source = new WhitespaceTokenizer(reader);
        ...
        IndexWriterConfig conf = new IndexWriterConfig(Version.LUCENE_4_10_2, indexAnalyzer);
        conf.setCodec(Codec.forName("Lucene49"));
