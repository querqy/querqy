...
public enum Language {
    ...
    Language(final Function<Float, SuffixGroup> morphemeFactory) {
        this.morphemeFactory = morphemeFactory;
    }

    public SuffixGroup createMorphemes(final float morphemeStructueWeight) {
        return morphemeFactory.apply(morphemeStructueWeight);
    }
