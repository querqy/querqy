...
public interface SearchEngineRequestAdapter {
     ...
     * <p>It will be the responsibility of the SearchEngineRequestAdapter implementation to derive the
     ...
     * {@link querqy.rewrite.ContextAwareQueryRewriter#CONTEXT_KEY_DEBUG_DATA} key.</p>
     *
     * @see #getContext()
     *
