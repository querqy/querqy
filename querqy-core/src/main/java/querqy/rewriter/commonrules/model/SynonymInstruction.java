...
public class SynonymInstruction implements Instruction {
    ...
    final List<querqy.rewriter.commonrules.model.Term> synonym;
    final float boost;
     ...
     */
    public SynonymInstruction(final List<querqy.rewriter.commonrules.model.Term> synonym,
                              final float boost,
    ...
    public void apply(final TermMatches termMatches, final ExpandedQuery expandedQuery,
        ...
        case 1: {
            ...
            if (synonym.size() == 1) {
                ...
                for (final querqy.rewriter.commonrules.model.Term synTerm: synonym) {
    ...
    protected void addSynonymTermToDisjunctionMaxQuery(final DisjunctionMaxQuery dmq,
                                                       final querqy.rewriter.commonrules.model.Term synTerm,
    ...
    public Set<Term> getGenerableTerms() {
        ...
        for (querqy.rewriter.commonrules.model.Term synTerm: synonym) {
