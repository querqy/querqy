...
public class BoostInstruction implements Instruction {
    ...
    /* (non-Javadoc)
     * @see querqy.rewriter.commonrules.model.Instruction#apply(querqy.rewriter.commonrules.model.PositionSequence,
     *                           querqy.rewriter.commonrules.model.TermMatches, int, int, querqy.model.ExpandedQuery,
     *                           java.util.Map)
     */
    @Override
    ...
    class CloneAndReplacePlaceHolderRewriter extends AbstractNodeVisitor<Node> {
        ...
        public Node visit(final Term term) {
            ...
            if (value instanceof querqy.rewriter.commonrules.model.Term) {
                querqy.rewriter.commonrules.model.Term termValue = (querqy.rewriter.commonrules.model.Term) value;
    ...
    class ToPlaceHolderTermRewriter extends AbstractNodeVisitor<Node> {
        ...
        public Node visit(final Term term) {
            ...
            final querqy.rewriter.commonrules.model.Term charSequence
                    = new querqy.rewriter.commonrules.model.Term(
                    value.toCharArray(),
                    0,
                    value.length(),
