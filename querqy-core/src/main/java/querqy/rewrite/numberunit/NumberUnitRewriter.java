 ...
 */
package querqy.rewrite.numberunit;
...
import querqy.rewrite.numberunit.NumberUnitQueryCreator;
import querqy.rewrite.numberunit.model.NumberUnitQueryInput;
import querqy.rewrite.numberunit.model.PerUnitNumberUnitDefinition;
...
public class NumberUnitRewriter extends AbstractNodeVisitor<Node> implements QueryRewriter {
    ...
    @Override
    public RewriterOutput rewrite(final ExpandedQuery expandedQuery, final SearchEngineRequestAdapter requestAdapter) {
